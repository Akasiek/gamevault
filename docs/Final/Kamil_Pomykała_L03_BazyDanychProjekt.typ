...
Jedynym problemem, na jaki natrafiłem, było zrozumienie konceptu ról, który zastępuje tradycyjnych użytkowników i grupy. Na szczęście PostgreSQL jest bardzo popularnym silnikem bazodanowym i istnieje wiele materiałów i dokumentacji, które pomagają w zrozumieniu tych koncepcji.
